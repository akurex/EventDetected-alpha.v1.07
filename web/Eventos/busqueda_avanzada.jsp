<%-- 
    ...
    Created on : 15-may-2012, 10:49:21
    Author     : jeison
--%>
...
<html> 
    ...
    <body> 
                ...
                <div data-role="content">	
                    ...
                    <ul data-role="listview" data-inset="true" data-divider-theme="f" >
                        ...
                        <li data-role="fieldcontain" >
                            ...
                            <input type="hidden" name="accion" id="accion" value="15" />
        ...
        <script>
        function go() {
            window.document.location.href="<%= request.getContextPath()%>/SEventos?accion=23&nombre="+window.document.getElementById('nombre').value
